Generated with [vike.dev/new](https://vike.dev/new) ([version 642](https://www.npmjs.com/package/create-vike/v/0.0.642)) using this command:

```sh
npm create vike@latest --- --react --tailwindcss --daisyui --prettier
```
