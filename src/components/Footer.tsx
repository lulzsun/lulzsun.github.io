import { ChatLeftQuoteFill, EnvelopeFill, FileEarmarkPdfFill, Github, Linkedin } from "./Icons";
  ...
  return (
    <>
      <div className="flex flex-row sm:w-3/4 md:w-4/6 lg:w-3/5 xl:w-2/5 pt-16 md:pb-16 place-content-center items-center gap-6">
        ...
        >
          <div className="inline-flex items-center place-content-center">
            <FileEarmarkPdfFill /> <span className="pl-3.5">Resume</span>
          </div>
        </button>
        ...
        >
          <div className="inline-flex items-center place-content-center">
            <EnvelopeFill /> <span className="pl-3.5 whitespace-nowrap">Contact Me</span>
          </div>
        </a>
      </div>
