...
import { BlogFile, Folder } from "../../../components/Icons";

export const metadata = {
  title: "Part 1: Hacking a Feit SEC3000 Floodlight Wifi Camera | Jimmy Quach",
  description: "Hacking a Feit SEC3000 Floodlight Wifi Camera",
  tags: ["hardware", "hacking"],
  created: new Date("2026-6-11"),
};
                    ...
                    <ul>
                      <li>
                        <details>
                          ...
                          <li>
                            <div
                              className="[&_pre]:overflow-x-auto [&_pre]:w-full pointer-events-auto cursor-text bg-transparent! text-inherit! hover:bg-transparent! active:bg-transparent! focus:bg-transparent!"
                              style={{
                                userSelect: "text",
