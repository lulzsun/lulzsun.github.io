...
{/*              */}
    <div className="items-left md:block md:w-4/6 lg:w-3/5 xl:w-2/5 md:mr-24 pb-6 md:pb-0">
      <div className="flex md:flex-col md:fixed top-24 z-50 gap-2">
        ...
        <a onClick={() => {document.getElementById("resumePdf")?.click()}} className="cursor-pointer group overflow-hidden bg-neutral-800 w-32 md:w-11 hover:w-32 h-11 rounded-full drop-shadow-lg flex justify-center items-center text-white hover:bg-neutral-500 hover:drop-shadow-2xl duration-300">
          <div className="md:fixed left-3.5 inline-flex items-center place-content-center">
