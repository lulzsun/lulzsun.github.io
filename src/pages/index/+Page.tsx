...
import { ChatLeftQuoteFill, FileEarmarkPdfFill, Github, Linkedin } from "../../components/Icons";
    ...
    <>
      ...
      <div className="sm:w-3/4 md:w-4/6 lg:w-3/5 xl:w-2/5 p-6">
        <Header greeting="Hello! My name is" title="Jimmy Quach" description="I build cool stuff.">
          <span className="text-stone-200">
            I'm a software engineer passionate about building amazing applications for users, currently specializing in
        ...
        <div className="justify-center flex flex-wrap md:flex-col md:fixed top-24 z-50 gap-2">
          ...
          >
            <div className="md:fixed left-3.5 inline-flex items-center place-content-center">
              <Github />
              <span className="pl-3.5">GitHub</span>
            </div>
          </a>
          <a
          ...
          >
            <div className="md:fixed left-3.5 inline-flex items-center place-content-center">
              <Linkedin />
              <span className="pl-3.5">Linkedin</span>
            </div>
          </a>
          <button
          ...
          >
            <div className="md:fixed left-3.5 inline-flex items-center place-content-center">
              <FileEarmarkPdfFill />
              <span className="pl-3.5">Resume</span>
            </div>
          </button>
          <a
          ...
          >
            <div className="md:fixed left-3.5 inline-flex items-center place-content-center">
              <ChatLeftQuoteFill />
              <span className="pl-3.5">Blog</span>
            </div>
          </a>
        </div>
      </div>
        ...
        <div className="text-stone-200">
          <div className="flex flex-row">
            <div className="flex flex-col space-y-2 mr-2">
              ...
              <span>
                I grew up fascinated with computers ever since, and eventually found myself to be a self-taught
                programmer all the way until college.
              </span>
              <span>
                Now with a bachelor's degree in computer science, I am looking to find my footing in the ever-growing
                world of technology. Check out my{" "}
                <a
      ...
      <div className="flex flex-col sm:w-3/4 md:w-4/6 lg:w-3/5 xl:w-2/5 p-6">
        ...
        <span className="flex">
          ...
          <span>
            <a className="underline underline-offset-2 text-red-300" href="https://github.com/lulzsun/RePlays">
              RePlays
            </a>{" "}
            is a free and open source program that automatically manages recording of detected running games, with a
            clip editor that allows for quick video sharing.
          </span>
        </span>
        <span className="flex">
          <span className="px-2 select-none">•</span>
          <span>
            <a className="underline underline-offset-2 text-red-300" href="https://whirled.jimmyqua.ch">
              Whirled
            </a>{" "}
            is an interactive social media website where users control their own avatars and visit virtual worlds. This
            is a passionate project of mine that is still work-in-progress, you can learn more at this{" "}
            <a className="underline underline-offset-2 text-red-300" href="/blog/what-is-whirled">
              blog post
            </a>
            .
          </span>
        ...
        <span className="flex">
          ...
          <span>
            ...
            <a className="underline underline-offset-2 text-red-300" href="https://github.com/geckosio/geckos.io">
              geckos.io
            </a>{" "}
